          ...
          __html: `
            (() => {
              ...
              const showBlockedGate = (user) => {
                ...
                panel.className = "mt-6 rounded-[22px] border border-[rgba(243,153,69,0.30)] bg-[#fff5ec] px-5 py-8 text-center";
                ...
                modal.innerHTML = '<div class="w-[520px] rounded-[24px] border border-[rgba(243,153,69,0.30)] bg-white p-6 shadow-[0_26px_80px_rgba(30,37,52,0.24)]"><p class="text-[18px] font-[900] text-[#10203f]">VIPS팀 요청 진입 불가</p><p class="mt-3 whitespace-pre-line text-[13px] font-[700] leading-6 text-[#435a7b]">미종료 거래가 남아 있어 VIPS팀 요청 진입이 불가합니다.\\n거래 종료 관리에서 남은 거래를 먼저 확인해주세요.</p><div class="mt-5 flex gap-2"><button data-open-trades="true" class="h-11 flex-1 rounded-xl bg-[#F39945] text-[13px] font-[900] text-white">미종료 거래 확인하기</button><button data-open-iki="true" class="h-11 flex-1 rounded-xl bg-[#1D50A2] text-[13px] font-[900] text-white">IKI 월마감 바로가기</button><button data-back-requests="true" class="h-11 flex-1 rounded-xl border border-[#dce6f3] bg-white text-[13px] font-[900] text-[#34496b]">요청 메뉴로</button></div></div>';
