...
export function HeroSection({ userName }: { userName: string }) {
  return (
    <section className="relative min-h-[166px] min-w-0 overflow-hidden rounded-[20px] border border-[#cbd5e1] bg-[linear-gradient(135deg,#fff7f3_0%,#ffffff_52%,#edf4ff_100%)] shadow-[0_12px_28px_rgba(15,23,42,0.085)] ring-1 ring-[#dbe4f0]">
      <div className="relative z-20 flex min-w-0 flex-col justify-center px-8 py-5 min-[1080px]:pr-[330px]">
      ...
      <div className="hero-visual absolute inset-y-0 right-0 z-10 hidden w-[320px] min-w-0 overflow-hidden min-[1080px]:block">
        <Image
          ...
          width={210}
          height={210}
          className="absolute right-[18px] top-[12px] z-10 max-h-[136px] max-w-[136px] object-contain opacity-55 drop-shadow-[0_12px_22px_rgba(239,68,68,0.10)]"
          priority
        />
        <Image
          ...
          width={285}
          height={285}
          className="absolute bottom-[-30px] left-[-8px] z-20 max-h-[228px] max-w-[228px] object-contain drop-shadow-[0_12px_18px_rgba(15,23,42,0.16)]"
          priority
        />
        <button
