...
export const monthlyItems = [
  ...
  { label: "장기 미진행 거래", count: "1건", amount: "75,000원", icon: CalendarCheck, tone: "blue" },
  { label: "Deduct 확인 필요", count: "0건", amount: "0원", icon: ShieldCheck, tone: "green" }
];

export const collectionItems = [
  { label: "수금 확인 필요", count: "1건", sub: "1,429,024원", icon: WalletCards, tone: "blue" },
  { label: "수금매칭 보류", count: "2건", sub: "부분입금 / 일괄입금 확인", icon: Banknote, tone: "orange" },
...
export const quickRequests: Array<{ kind: RequestKind; label: string; icon: LucideIcon; tone: string }> = [
  ...
  { kind: "depositConfirmation", label: "입금확인\n요청", icon: Landmark, tone: "orange" },
  { kind: "invoiceMatching", label: "계산서매칭", icon: FileText, tone: "red" }
];
